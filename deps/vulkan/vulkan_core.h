...
typedef enum VkSharingMode {
  ...
  VK_SHARING_MODE_RANGE_SIZE =
      (VK_SHARING_MODE_CONCURRENT - VK_SHARING_MODE_EXCLUSIVE + 1),
...
typedef enum VkImageLayout {
  ...
  VK_IMAGE_LAYOUT_RANGE_SIZE =
      (VK_IMAGE_LAYOUT_PREINITIALIZED - VK_IMAGE_LAYOUT_UNDEFINED + 1),
...
typedef enum VkImageViewType {
  ...
  VK_IMAGE_VIEW_TYPE_RANGE_SIZE =
      (VK_IMAGE_VIEW_TYPE_CUBE_ARRAY - VK_IMAGE_VIEW_TYPE_1D + 1),
...
typedef enum VkComponentSwizzle {
  ...
  VK_COMPONENT_SWIZZLE_RANGE_SIZE =
      (VK_COMPONENT_SWIZZLE_A - VK_COMPONENT_SWIZZLE_IDENTITY + 1),
...
typedef enum VkPolygonMode {
  ...
  VK_POLYGON_MODE_RANGE_SIZE =
      (VK_POLYGON_MODE_POINT - VK_POLYGON_MODE_FILL + 1),
...
typedef enum VkFrontFace {
  ...
  VK_FRONT_FACE_RANGE_SIZE =
      (VK_FRONT_FACE_CLOCKWISE - VK_FRONT_FACE_COUNTER_CLOCKWISE + 1),
...
typedef enum VkStencilOp {
  ...
  VK_STENCIL_OP_RANGE_SIZE =
      (VK_STENCIL_OP_DECREMENT_AND_WRAP - VK_STENCIL_OP_KEEP + 1),
...
typedef enum VkBlendFactor {
  ...
  VK_BLEND_FACTOR_RANGE_SIZE =
      (VK_BLEND_FACTOR_ONE_MINUS_SRC1_ALPHA - VK_BLEND_FACTOR_ZERO + 1),
...
typedef enum VkSamplerAddressMode {
  ...
  VK_SAMPLER_ADDRESS_MODE_RANGE_SIZE =
      (VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_BORDER -
       VK_SAMPLER_ADDRESS_MODE_REPEAT + 1),
...
typedef enum VkBorderColor {
  ...
  VK_BORDER_COLOR_RANGE_SIZE = (VK_BORDER_COLOR_INT_OPAQUE_WHITE -
                                VK_BORDER_COLOR_FLOAT_TRANSPARENT_BLACK + 1),
...
typedef enum VkObjectType {
  ...
  VK_OBJECT_TYPE_RANGE_SIZE =
      (VK_OBJECT_TYPE_COMMAND_POOL - VK_OBJECT_TYPE_UNKNOWN + 1),
...
typedef enum VkRasterizationOrderAMD {
  ...
  VK_RASTERIZATION_ORDER_RANGE_SIZE_AMD =
      (VK_RASTERIZATION_ORDER_RELAXED_AMD - VK_RASTERIZATION_ORDER_STRICT_AMD +
       1),
